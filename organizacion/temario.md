...
|---|---|---|
| Pago a proveedor extranjero sin diferencial cambiario ni demora | Pago con conversión + ancla de salida | [`docs/sep-estandares-anclas.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/docs/sep-estandares-anclas.md) |
| Dispersión de nómina o pagos a múltiples proveedores | Dispersión en lote idempotente | [`contracts/payroll`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/payroll) |
| Liberación del pago condicionada al cumplimiento de la entrega | Custodia condicionada | [`contracts/escrow`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/escrow) |
| Adelanto del cobro de una factura a plazo | Crédito colateralizado / factoraje | [`contracts/loan`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/loan) |
| Acreditación de origen, lote y certificación de un insumo | Trazabilidad con eventos en cadena | [`contracts/food-trace`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/food-trace) |
| Fondo de ahorro o apartado por objetivo | Metas de ahorro | [`contracts/savings`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/savings) |
| Rendimiento sobre tesorería ociosa | Bóveda de rendimiento | [`contracts/yield`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/yield) |
| Membresías, garantías extendidas y acceso B2B | Credencial de membresía | [`contracts/nft-membership`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/nft-membership) |
| Decisiones colegiadas con voto verificable | Votación | [`contracts/voting`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/voting) |
| Constancias, asistencia y certificaciones | Registro de credenciales | [`contracts/attendance`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/contracts/attendance) |

Documentación completa de cada patrón —modelo mínimo, datos en cadena, eventos y riesgos— en [`docs/contratos-casos-uso.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/docs/contratos-casos-uso.md), y combinaciones de extremo a extremo en [`docs/playbooks-producto.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/docs/playbooks-producto.md).
...
| N3 · operación en red de pruebas | [`exercises/01-pago-simple.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/exercises/01-pago-simple.md) |
| N3 · interfaz sobre contrato | [`docs/frontend-contratos.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/docs/frontend-contratos.md) y las interfaces de [`frontend/`](https://github.com/CriptoUNAM-Team/Stellar-Guide/tree/main/frontend), que generan los formularios a partir de la especificación de cada contrato desplegado |
| Diagrama de la solución | [`docs/flujos-mermaid.md`](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/docs/flujos-mermaid.md) |
...
- **Continuidad:** ruta de profundización a través del [programa de 12 semanas](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/course/README.md) sobre Stellar y contratos Soroban, y vinculación con los programas de la fundación y con empresas de la cámara para pilotos.
