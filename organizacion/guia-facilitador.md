...
- Enseña la ruta que sigue: el [curso de 12 semanas](https://github.com/CriptoUNAM-Team/Stellar-Guide/blob/main/course/README.md) de este repo para quien quiera profundizar, y la vinculación con empresas de la cámara para los equipos con piloto identificado.
